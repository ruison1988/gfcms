...
include RUNTIME_CONTROL.'admin_control.class.php'; class my_control extends admin_control {
	// 我的首页
	public function index() {
		...
		$stat['space'] = function_exists('disk_free_space') ? get_byte(disk_free_space(ROOT_PATH)) : '未知';
	...
	private function get_used() {
		$arr = array(
			array('name'=>'发布文章', 'url'=>'article/add', 'imgsrc'=>'admin/default/img/ico/article_add.jpg'),
			array('name'=>'文章管理', 'url'=>'article/index', 'imgsrc'=>'admin/default/img/ico/article_index.jpg'),
			array('name'=>'发布产品', 'url'=>'product/add', 'imgsrc'=>'admin/default/img/ico/product_add.jpg'),
			array('name'=>'产品管理', 'url'=>'product/index', 'imgsrc'=>'admin/default/img/ico/product_index.jpg'),
			array('name'=>'发布图集', 'url'=>'photo/add', 'imgsrc'=>'admin/default/img/ico/photo_add.jpg'),
			array('name'=>'图集管理', 'url'=>'photo/index', 'imgsrc'=>'admin/default/img/ico/photo_index.jpg'),
			array('name'=>'评论管理', 'url'=>'comment/index', 'imgsrc'=>'admin/default/img/ico/comment_index.jpg'),
			array('name'=>'分类管理', 'url'=>'category/index', 'imgsrc'=>'admin/default/img/ico/category_index.jpg'),
		);
