...
include RUNTIME_CONTROL.'admin_control.class.php'; class article_control extends admin_control {
	// 内容管理
	...
	private function img_replace($mat) {
		...
		if($file) {
			...
			if(!empty($cfg['watermark_pos'])) {
				image::watermark($conf['upDir'].$file, ROOT_PATH.'web/img/watermark.png', null, $cfg['watermark_pos'], $cfg['watermark_pct']);
			}
