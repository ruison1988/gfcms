...
<link href="http://wdt.my.com/tpl/admin/default/css/login.css" type="text/css" rel="stylesheet" />
</head>

<body>
<form method="post" action="<?php echo(isset($C['hostname']) ? $C['hostname'] : ''); ?>admin/index/login">
<input type="hidden" name="FORM_HASH" value="<?php echo(isset($C['FORM_HASH']) ? $C['FORM_HASH'] : ''); ?>" />
<dl id="lgn">
