...
class YYWechat {
     ...
     * 设置微信服务器发来的信息
     */
	public function setRev($postxml)
	{
...
<Nonce><![CDATA[%s]]></Nonce>
	...
	protected function setCache($cachename,$value,$expired){
		...
		$ret = TTCache::set($cachename,$value,$expired);
		if($ret) return $ret;
		return false;
	}
	...
	protected function removeCache($cachename){
		...
		$ret = TTCache::set($cachename,null);
		return true;
	}
	...
	public function getOauthAccessToken(){
		//本地调试环境
		if(TMEnvConfig::getEnv() == 'test'){
			return array( 'openid'=>'o-Grnt96kPAKrrDBiNBnz1xsHdea' );
		}
	...
	/**
	 * 获取授权后的用户资料 ！！！此处的access_token为oauth类型，注意与普通的access_token区分！！！
	...
	public function getOauthUserinfo($access_token,$openid){
		if(TMEnvConfig::getEnv() == 'test'){
			return array(
				'openid'=>'o-Grnt96kPAKrrDBiNBnz1xsHdea',
				'headimgurl' => 'http://shp.qpic.cn/app_actsec/20d93826f59f7bc5275d36dbb25807f272585bf88192f44e11f96ec708287a87eb31fe5c3dc4b03ea7c93a23b5d6d06e/0',
				'nickname' => '辉啊',
				'sex'=>1,
				'country'=>'中国',
				'province'=>'广东省',
