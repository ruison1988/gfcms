...
<div class="content">
	...
	<table class="tb">
		...
		<tr>
			<td>数据库名</td>
			<td><input class="inp" id="dbname" name="dbname" type="text" value="gfcms" tips="请填写数据库名"></td>
		</tr>
		<tr>
			<td>表前辍</td>
			<td><input class="inp" id="dbpre" name="dbpre" type="text" value="gf_" tips="如安装多套gfcms，请修改"></td>
		</tr>
		<tr>
			<td>覆盖安装</td>
	...
	<table class="tb">
		...
		<tr>
			<td width="80">网站域名</strong></td>
			<td><input class="inp" id="hostname" name="hostname" type="text" value="xxx.com" tips="请填写域名"></td>
		</tr>
		<tr>
		...
		<tr>
			<td>密码</strong></td>
			<td><input class="inp" id="adm_pass" name="adm_pass" type="password" value="" tips="请填写密码，不能小于5位"></td>
		</tr>
	</table>
</div>
